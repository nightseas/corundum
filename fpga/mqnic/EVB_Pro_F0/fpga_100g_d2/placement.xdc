...
add_cells_to_pblock [get_pblocks pblock_slr2] [get_cells -quiet [list core_inst/iface[0].interface_inst]]
add_cells_to_pblock [get_pblocks pblock_slr2] [get_cells -quiet [list core_inst/iface[1].interface_inst]]
...
resize_pblock [get_pblocks pblock_pcie] -add {CLOCKREGION_X0Y10:CLOCKREGION_X2Y14}
