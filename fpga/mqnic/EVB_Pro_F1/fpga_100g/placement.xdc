...
add_cells_to_pblock [get_pblocks pblock_eth0] [get_cells -quiet [list core_inst0/iface[0].mac[0].mac_tx_fifo_inst]]
add_cells_to_pblock [get_pblocks pblock_eth0] [get_cells -quiet [list core_inst0/iface[0].mac[0].mac_rx_fifo_inst]]
add_cells_to_pblock [get_pblocks pblock_eth0] [get_cells -quiet [list core_inst0/iface[0].mac[0].tx_ptp_ts_fifo]]
# add_cells_to_pblock [get_pblocks pblock_eth0] [get_cells -quiet [list qsfp0_2_cmac_pad_inst]]
# add_cells_to_pblock [get_pblocks pblock_eth0] [get_cells -quiet [list core_inst0/iface[1].mac[0].mac_tx_fifo_inst]]
# add_cells_to_pblock [get_pblocks pblock_eth0] [get_cells -quiet [list core_inst0/iface[1].mac[0].mac_rx_fifo_inst]]
# add_cells_to_pblock [get_pblocks pblock_eth0] [get_cells -quiet [list core_inst0/iface[1].mac[0].tx_ptp_ts_fifo]]
...
add_cells_to_pblock [get_pblocks pblock_eth1] [get_cells -quiet [list core_inst1/iface[0].mac[0].mac_tx_fifo_inst]]
add_cells_to_pblock [get_pblocks pblock_eth1] [get_cells -quiet [list core_inst1/iface[0].mac[0].mac_rx_fifo_inst]]
add_cells_to_pblock [get_pblocks pblock_eth1] [get_cells -quiet [list core_inst1/iface[0].mac[0].tx_ptp_ts_fifo]]
# add_cells_to_pblock [get_pblocks pblock_eth1] [get_cells -quiet [list qsfp1_2_cmac_pad_inst]]
# add_cells_to_pblock [get_pblocks pblock_eth1] [get_cells -quiet [list core_inst1/iface[1].mac[0].mac_tx_fifo_inst]]
# add_cells_to_pblock [get_pblocks pblock_eth1] [get_cells -quiet [list core_inst1/iface[1].mac[0].mac_rx_fifo_inst]]
# add_cells_to_pblock [get_pblocks pblock_eth1] [get_cells -quiet [list core_inst1/iface[1].mac[0].tx_ptp_ts_fifo]]
...
resize_pblock [get_pblocks pblock_pcie2] -add {CLOCKREGION_X3Y10:CLOCKREGION_X5Y12}

create_pblock pblock_eth2
add_cells_to_pblock [get_pblocks pblock_eth2] [get_cells -quiet [list qsfp2_1_cmac_pad_inst]]
add_cells_to_pblock [get_pblocks pblock_eth2] [get_cells -quiet [list core_inst2/iface[0].mac[0].mac_tx_fifo_inst]]
add_cells_to_pblock [get_pblocks pblock_eth2] [get_cells -quiet [list core_inst2/iface[0].mac[0].mac_rx_fifo_inst]]
add_cells_to_pblock [get_pblocks pblock_eth2] [get_cells -quiet [list core_inst2/iface[0].mac[0].tx_ptp_ts_fifo]]
# add_cells_to_pblock [get_pblocks pblock_eth2] [get_cells -quiet [list qsfp2_2_cmac_pad_inst]]
# add_cells_to_pblock [get_pblocks pblock_eth2] [get_cells -quiet [list core_inst2/iface[1].mac[0].mac_tx_fifo_inst]]
# add_cells_to_pblock [get_pblocks pblock_eth2] [get_cells -quiet [list core_inst2/iface[1].mac[0].mac_rx_fifo_inst]]
# add_cells_to_pblock [get_pblocks pblock_eth2] [get_cells -quiet [list core_inst2/iface[1].mac[0].tx_ptp_ts_fifo]]
